<template>
  <main>
    <section id="artists" class="pt-16">
      <div class="px-4 py-12 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:py-24">
        <div class="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
          <div class="space-y-5 sm:space-y-4">
            <h2
              class="text-3xl font-extrabold tracking-tight text-center sm:text-4xl sm:text-left"
            >
              Artists
            </h2>
            <p class="text-xl text-center text-gray-500 sm:text-left">
